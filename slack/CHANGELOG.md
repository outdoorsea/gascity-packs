...
All notable changes to slack are documented in this file.
...
- Moved CLI commands (`gc slack import-app`, `map-channel`, `map-rig`,
  ...
  binary into a new in-pack Go module at `examples/slack/cli/`
...
- Build flow simplified to a single command:
  `cd examples/slack/adapter && go build -o gc-slack-adapter`.
...
This release was developed in-tree at `examples/slack/` (with the
...
[0.1.0]: https://github.com/gastownhall/gascity/commits/main/examples/slack
