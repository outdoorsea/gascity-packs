"""In-process mock of gc's HTTP API surface for slack E2E tests.

Implements the minimum subset slack scripts touch:
...
class GcMock:
    ...
    def register_inbound_event(
        ...
        *,
        ...
        arrives at the slack adapter and gets forwarded to /extmsg/inbound.
        """
        event = {
            "type": "extmsg.inbound",
            "payload": {
