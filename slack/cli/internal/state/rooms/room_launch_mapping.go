...
// by `gc slack enable-room-launch` and read by the slack adapter
...
// enable-room-launch` and read by the slack adapter when
...
// `gc slack enable-room-launch`. The slack adapter reads this
