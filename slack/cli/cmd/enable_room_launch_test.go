...
// and reminds the operator to restart the slack adapter.
func TestEnableRoomLaunchHappyPath(t *testing.T) {
	...
	if !strings.Contains(stdout, "Send SIGHUP to slack adapter") {
...
// --launcher because the slack adapter has nothing to spawn.
